...
{
    public interface ITGPay
    {

    }

    public class TGPayClient : SecureProtocolBase, ITGPay
    {
        public TGPayClient() { }

        public TGPayClient(string platform) 
            : base(platform)
        {

        }

        public TGPayClient(string platform, SecureKeyInfo secure)
